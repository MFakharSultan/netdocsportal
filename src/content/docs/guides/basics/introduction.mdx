...
description: Learn the basics of networking in a simple and beginner-friendly way.
---

import { Aside, Card } from "@astrojs/starlight/components";

<Aside type="tip">
  To support me for this helpful resource, [click here](/support).
</Aside>


## Networking

Before we talk about networking in computer science, let’s first understand what a **network** is. 
...
![company-network-example](/images/basics/public-network.webp)
...
We can define a computer network as:

<Card title="Definition">
  _A network of interconnected computing devices that can exchange data and share resources._
</Card>
...
![computer-network-example](/images/basics/computer-network.webp)

## Summary

In this chapter, we learned that **networking** is about building connections—whether between people or between computers. Just like people form relationships to share knowledge and support one another, computers connect in **computer networks** to exchange data and share resources.
...
<Aside type="note">
  In the next chapter, we’ll explore the **types of computer networks**, such as LAN, WAN, and the internet, and how they function in real life.
</Aside>
