...
<Image
  src="/images/basics/public-network.webp"
  alt="A company network."
  width={1200}
  height={630}
  loading="eager"
/>
...
<Card title="Definition">
  _A network of interconnected computing devices that can exchange data and
  share resources._
</Card>
...
<Image
  src="/images/basics/computer-network.webp"
  alt="A computer network."
  width={1200}
  height={630}
/>
...
<Aside type="note">
  In the next chapter, we’ll explore the **types of computer networks**, such as
  LAN, WAN, and the internet, and how they function in real life.
</Aside>
