...
<Image
  src="/images/basics/man-network.webp"
  alt="A MAN network diagram"
  width={1200}
  height={630}
/>
...
<Image
  src="/images/basics/wan-network.webp"
  alt="A WAN network diagram"
  width={1200}
  height={630}
/>
...
<Image
  src="/images/basics/pan-network.webp"
  alt="A PAN network diagram"
  width={1200}
  height={630}
/>
...
<Aside type="note">
  In the next section, we’ll look at some **specialized networks**, such as
  wireless networks, VPNs, and storage networks—and how they help in different
  situations.
</Aside>
