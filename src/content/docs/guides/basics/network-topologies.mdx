...
![](/images/basics/bus-topology.webp)
...
![](/images/basics/star-topology.webp)
...
![](/images/basics/ring-topology.webp)
...
![](/images/basics/mesh-topology.webp)
...
![](/images/basics/hybrid-topology.webp)
...
<Aside type="note">
  In the next chapter, we’ll learn about **network devices**—like routers, switches, and hubs—that make these topologies work in real life.
</Aside>
