...
![](/images/basics/wlan-network.gif)
...
![](/images/basics/san-network.webp)
...
<Aside type="note">
  In the next chapter, we’ll explore **network topologies**—the physical and logical layout of how computers and devices are arranged in a network.
</Aside>
