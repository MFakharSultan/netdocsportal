---
title: Specialized Computer Networks
description: Learn about specialized networks like WLAN, VPN, SAN, and others, and how they serve specific needs in different environments.
---

import { Image } from "astro:assets";
import { Aside } from "@astrojs/starlight/components";

In the previous chapter, we explored the **main types of computer networks**—like LAN, WAN, MAN, and PAN. These are the building blocks of modern communication.
...
A **Wireless LAN (WLAN)** is just like a regular [LAN](/guides/basics/types-of-computer-networks/#1-local-area-network-lan)—but without wires.
...
<video autoplay loop muted playsinline>
  <source src="/videos/basics/wlan-network.mp4" type="video/mp4" />
...
<video autoplay loop muted playsinline>
  <source src="/videos/basics/vpn-network.mp4" type="video/mp4" />
  Your browser does not support the video tag.
</video>
---
...
<Image
  src="/images/basics/san-network.webp"
  alt="A SAN network diagram"
  width={1200}
  height={630}
/>
...
A **Campus Area Network (CAN)** connects multiple LANs within a **single campus**—like a university, military base, or corporate campus.

It’s larger than a LAN but smaller than a MAN. CANs are designed to offer reliable and high-speed communication across a set of nearby buildings.
...
| **Network Type** | **Purpose**                                  | **Example Use Case**                             |
| ---------------- | -------------------------------------------- | ------------------------------------------------ |
| **WLAN**         | Wireless local network                       | Home Wi-Fi, coffee shop internet                 |
| **VPN**          | Secure connection over public internet       | Remote work, privacy protection                  |
| **SAN**          | High-speed storage access                    | Data centers, video hosting platforms            |
| **CAN**          | Connect multiple LANs within a campus        | University buildings, military bases             |
| **EPN**          | Private network for enterprise use           | Company offices across regions                   |
| **VAN**          | Logical grouping of devices across a network | Department-based access control in organizations |

---

As you can see, computer networks can be customized in many ways to meet the needs of different users and environments. Each specialized network helps solve real-world problems—whether it's staying mobile, secure, or scalable.

<Aside type="note">
  In the next chapter, we’ll explore **network topologies**—the physical and
  logical layout of how computers and devices are arranged in a network.
</Aside>
